...
// 2026-02-25 D+3 REVIEW 간단 복습 완료

// 2026-02-20 Reboot 간단 복습
// 알파벳이 나온 빈도 배열 생성
// 만약 빈도가 홀수인 알파벳이 2개 이상이라면 팰린드롬이 아님
// 빈도가 홀수인 알파벳의 빈도를 하나 줄이고
// 빈도 / 2 만큼 알파벳 순서대로 연속해서 출력한다
// 빈도가 홀수인 알파벳을 출력한다. 없으면 넘어간다.
// 남은 빈도만큼 알파벳 역순으로 출력한다
