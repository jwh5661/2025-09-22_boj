...
// 2026-02-27 D+3 REIVEW 간단 복습 완료

// 2026-02-23 Reboot 간단 복습
// 숫자 받을 때 문자가 나오기 전까지 10의 자리씩 옮겨서 저장
// 배열의 왼쪽 / 오른쪽 인덱스를 초기화해두고 
// 삭제 연산이 나오면 인덱스를 늘리거나 줄여서 실제로 삭제가 일어나지 않도록 함
// 삭제할 수 없다면 error을 지정하는 bool 값을 true로 하고 해당 연산 종료
// 뒤집기 연산이 나오면 bool 값을 변경시켜 실제로 뒤집지 않도록 함
// 현재 상태에 따라 출력
